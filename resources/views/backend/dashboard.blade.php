            ...
            <div class="card-header py-2">
                <div class="d-flex justify-content-between">
                    <div class="left-item" style="color: #000000e0">
                        <h2><i class="fa-solid fa-chart-pie"></i><span class="pl-1">Report</span></h2>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                        <div class="p-2 px-3 bg-primary text-white d-flex justify-content-between">
                            <div class="">
                                <h2 class="dashboard-card-ammount">Total Student</h2>
                                <h2 class="dashboard-card-title">500</h2>
                            </div>
                        ...
                        <div class="p-1 text-center text-white" style="background-color:#005bbd;">
                            <h6 class="mb-0"><a class="text-white" href="">More info <i class="fa-solid fa-arrow-right"></i></a></h6>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                        <div class="p-2 px-3 bg-info text-white d-flex justify-content-between">
                            <div class="">
                                <h2 class="dashboard-card-ammount">Male</h2>
                                <h2 class="dashboard-card-title">280</h2>
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                        <div class="p-2 px-3 bg-success text-white d-flex justify-content-between">
                            <div class="">
                                <h2 class="dashboard-card-ammount">Female</h2>
                                <h2 class="dashboard-card-title">200</h2>
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                        <div class="p-2 px-3 bg-secondary text-white d-flex justify-content-between">
                            <div class="">
                                <h2 class="dashboard-card-ammount">Others</h2>
                                <h2 class="dashboard-card-title">20</h2>
                            </div>
