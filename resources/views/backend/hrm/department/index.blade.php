    ...
    <div class="col-md-12 col-sm-12">
        ...
        <div class="x_panel">
            <div class="d-flex justify-content-between">
                <h2 style="font-size: 26px;">Department</h2>
            </div>
        </div>
              ...
              <table class="table table-striped jambo_table bulk_action table-bordered" id="myTable">
                <thead>
                  <tr class="headings">
                    ...
                    <th class="column-title">Total Staff</th>
  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title">Department Create</h5>
          ...
          <form id="form">
              @csrf
                  <div class="form-group">
                      ...
                      <input type="text" id="name" class="form-control input-default" name="name" placeholder="Enter Department Name">
...
<script>
    ...
    async function getDepartment(){
        await $.ajax({
            url : `{{route('department.get-department')}}`,
            type : "GET",
            dataType : "JSON",
            success : (response)=>{
